    ...
    <div class="max-w-2xl mx-auto relative">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 text-sm">Update product details</p>
            </div>
            <div class="hidden md:block text-right">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-xs text-blue-600 font-medium">
        ...
        <form action="{{ route('seller.products.update', $product) }}" method="POST" enctype="multipart/form-data"
            ...
            x-data="{
                ...
                categoryName: '{{ $categories->firstWhere('id', old('category_id', $product->category_id))?->name ?? 'Select a category' }}',
                categoryOpen: false
            }">
            ...
            <div class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <button type="button" @click="categoryOpen = !categoryOpen" @click.away="categoryOpen = false"
                        :class="{ 'border-primary ring-4 ring-primary/10 bg-white': categoryOpen, 'border-gray-200 bg-gray-50/50':
                                !categoryOpen }"
                    ...
                    <div x-show="categoryOpen" x-transition:enter="transition ease-out duration-200"
                        ...
                        class="absolute z-20 w-full mt-2 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden max-h-44 overflow-y-auto no-scrollbar"
                        style="display: none;">
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Describe your product details, features, and specs..." required>{{ old('description', $product->description) }}</textarea>
                    </div>
                    @error('description')
