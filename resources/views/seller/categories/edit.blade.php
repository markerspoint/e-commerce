...
@section('title', 'Edit Category - Seller Dashboard')
    ...
    <div class="max-w-2xl mx-auto relative">
        ...
        <form action="{{ route('seller.categories.update', $category) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="space-y-4 pt-2">
                ...
                <div x-data="{ preview: '{{ $category->image ? Storage::url($category->image) : '' }}' }">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-2xl h-48 flex flex-col justify-center text-center hover:border-primary hover:bg-green-50/20 transition cursor-pointer relative overflow-hidden group bg-gray-50/30"
                        ...
                        <input type="file" name="image" id="image" class="hidden" accept="image/*"
                            @change="preview = $event.target.files[0] ? URL.createObjectURL($event.target.files[0]) : '{{ $category->image ? Storage::url($category->image) : '' }}'">
